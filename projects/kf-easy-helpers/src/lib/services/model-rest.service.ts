...
export class ModelRest {
  ...
  constructor(
    ...
    this.observerRequest = helper.env.observerType
      ? helper.env.observerType
      : "body";
  }
  public get url() {
    const url =
      ...
      this.main_path +
      this.apiUrl +
      (this.custons.addUrl ? "/" + this.custons.addUrl : "");
  ...
  protected handleLoop(errors: any) {
